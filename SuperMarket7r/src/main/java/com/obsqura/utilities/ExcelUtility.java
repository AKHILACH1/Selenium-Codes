...
public class ExcelUtility {
	...
	f = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\Resources\\TestData.xlsx");
	...
	int value = (int) ((org.apache.poi.ss.usermodel.Cell) c).getNumericCellValue();
